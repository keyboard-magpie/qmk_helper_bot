...
module.exports = {
  ...
  keychroninvite: 'https://discord.gg/6Sr9r9T7Nc',
  keychron: 'Many newer Keychron boards are not merged into the main QMK repository yet. You should ask for help using their fork on the Keychron Discord server.\n\nGitHub: <https://github.com/Keychron/qmk_firmware/tree/playground>\nDiscord: ',
