...
module.exports = {
  ...
  volunteers: 'To gain some perspective, please have a read of these links:\n- [Don\'t be that open-source user, don\'t be me](https://jacobtomlinson.dev/posts/2022/dont-be-that-open-source-user-dont-be-me/)\n- [Open Source Maintainers Owe You Nothing](https://mikemcquaid.com/2018/03/19/open-source-maintainers-owe-you-nothing/)\m- [GitHub Etiquette](https://github.com/kossnocorp/etiquette/blob/master/README.md)',
